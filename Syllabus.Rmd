...
### **Weekly Assignments**
These will be announced in class and detailed instructions will be posted on the course GitHub repository. They will generally consist of requiring you to complete a task using R and to upload your code as an R script to Canvas. Some may vary. Any data sets required for the assignment will be on the GitHub repository as well. These assignments will not be accepted for credit after the due date.

### **Skills Tests**
These will take place during class time. They will be similar to the sorts of tasks on the precedent Weekly Assignments, and you will be "open book," but they will be timed.
