...
The files you will need are:
	DNA_Conc_by_Extraction_Date.csv.gz
...
III.
Once you have your code for creating the figures correctly, you need to save those two images in your PERSONAL github repository. Name them similarly to how I named mine.
...
and another column that contains the AVERAGE of the values within that year.  Just to be clear, this data frame should have only 12 rows (one for each year).
...
I will go to your online github repository (MAKE SURE YOU HAVE UPLOADED THIS LINK FOR ASSIGNMENT 1 IN CANVAS) and check for the above 4 items.
...
10 pts - Make boxplots by year (as seen on screen) for each lab tech's concentrations (proper labels)
10 pts - Save those 2 boxplots as jpeg files on your personal github website (use intuitive file names)
